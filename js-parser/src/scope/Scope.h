...
namespace jetpack {
    ...
    public:
        ...
        virtual PVar RecursivelyFindVariable(const IMString& var_name);
        ...
        inline bool RemoveVariable(const IMString& name) {
        ...
        virtual bool BatchRenameSymbols(const std::vector<std::tuple<IMString, IMString>>& changeset);

        virtual ~Scope() = default;

        HashMap<IMString, PVar> own_variables;
    ...
    public:
        using ChangeSet = std::vector<std::tuple<IMString, IMString>>;
